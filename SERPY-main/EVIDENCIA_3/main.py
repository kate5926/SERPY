...
def main():
    # Configuración de archivos - USAR RUTA ABSOLUTA
    directorio_actual = os.path.dirname(os.path.abspath(__file__))
    archivo_fuente = os.path.join(directorio_actual, "codigo_fuente.txt")
    archivo_tabla = os.path.join(directorio_actual, "tabla_ll1.csv")
    
    print(f"Buscando archivo en: {archivo_fuente}")  # Debug
